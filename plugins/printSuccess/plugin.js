...
module.exports = {
  async apply(value, previousValues) {
    return new Promise((resolve) => {
      console.log('\n');
      console.log(
        'TheCodingMachine React-Native MyNotepad initialized with success ! 🚀\n',
      );
      console.log(
        `${green(
          '                                                                    .-`    `::  \n' +
      ...
      console.log(
        '- 📚 If you need to read more about this mynotepad : https://thecodingmachine.github.io/react-native-mynotepad/',
      );
      console.log(
        '- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-mynotepad/issues',
      );
      console.log(
        '- ⭐ If you love this mynotepad, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-mynotepad',
      );
